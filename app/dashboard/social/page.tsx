...
export default function SocialPage() {
  ...
  const [currentPlatform, setCurrentPlatform] = useState<"INSTAGRAM" | "X">(
    "INSTAGRAM",
  );
  ...
  const toggleActive = async (post: SocialPost) => {
    ...
    if (!post.isActive && !canActivate(post.platform, post.id)) {
      setError(
        `Cannot activate. Maximum 3 active ${post.platform === "INSTAGRAM" ? "Instagram" : "X"} posts allowed.`,
      );
  ...
  const handleCreate = async () => {
    ...
    if (createForm.isActive && !canActivate(currentPlatform)) {
      setError(
        `Cannot create as active. Maximum 3 active ${currentPlatform === "INSTAGRAM" ? "Instagram" : "X"} posts allowed.`,
      );
      setTimeout(() => setError(null), 5000);
      return;
    }
  ...
  const handleUpdate = async () => {
    ...
    if (
      editForm.isActive &&
      !editingPost.isActive &&
      !canActivate(editingPost.platform, editingPost.id)
    ) {
      setError(
        `Cannot activate. Maximum 3 active ${editingPost.platform === "INSTAGRAM" ? "Instagram" : "X"} posts allowed.`,
      );
      setTimeout(() => setError(null), 5000);
      return;
    }
  ...
  const PostCard = ({ post }: { post: SocialPost }) => {
    ...
    return (
      <div className="bg-white rounded-xl border border-gray-200 overflow-hidden  transition-shadow">
       ...
       <div className="relative bg-gray-50 border-b border-gray-200 min-h-[300px] sm:min-h-[400px]">
    ...
    <div className="min-h-screen bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Manage your Instagram and X (Twitter) posts. Maximum 3 active posts
            per platform.
          </p>
        </div>
        ...
        {/* X (Twitter) Section */}
        <section>
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center sm:justify-between mb-6">
            <div className="flex items-center gap-3">
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-xl border border-gray-200 w-full max-w-lg mx-2 sm:mx-0">
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setCreateForm({ ...createForm, postUrl: e.target.value })
                  }
            ...
            <div className="p-6 space-y-4">
              <div>
                ...
                <input
                  ...
                  onChange={(e) =>
                    setEditForm({ ...editForm, postUrl: e.target.value })
                  }
                  className="w-full px-4 py-2.5 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-transparent placeholder:text-gray-400 text-gray-900 transition-all"
                  placeholder="https://..."
                />
