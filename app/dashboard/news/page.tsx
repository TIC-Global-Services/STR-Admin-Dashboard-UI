...
export default function NewsPage() {
  ...
  return (
    <div className="min-h-screen bg-white p-4 sm:p-6 lg:p-8">
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="p-4 sm:p-6 border-t border-gray-200 flex items-center justify-end gap-3 sticky bottom-0 bg-white">
              <button
                ...
                className="px-4 sm:px-5 py-2.5 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-all text-sm font-medium"
                disabled={creating}
              >
                Cancel
              </button>
      ...
      {/* Edit News Modal - Same responsive structure as Create Modal */}
              ...
              <>
                ...
                <div className="p-4 sm:p-6 border-t border-gray-200 flex items-center justify-end gap-3 sticky bottom-0 bg-white">
                  <button
                    ...
                    className="px-4 sm:px-5 py-2.5 border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition-all text-sm font-medium cursor-pointer"
                    disabled={updating}
                  >
                    Cancel
                  </button>
          ...
          <div className="bg-white rounded-xl border border-gray-200 shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            {!previewNews ? (
              ...
              <div className="p-4 sm:p-6 lg:p-8">
                ...
                {/* Summary */}
                {previewNews.summary && (
                  <p className="text-base sm:text-lg text-gray-600 mb-6 pb-6 border-b border-gray-200">
                    {previewNews.summary}
                  </p>
                )}
